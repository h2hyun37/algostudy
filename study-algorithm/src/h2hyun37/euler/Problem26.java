...
public class Problem26 extends AbstractProblem {
	 ...
	 *
	 *
	 * String[0]은 순환소수 여부를 나타낸다. (1=순환소수, 0=순환소수가 아님) <br />
	 * String[1]은 소수점 이하의 숫자. 4/3=1.333... 에서 3, 1/7=0.142857... 에서 142857.
	 * (반복되는 순환소수부분은 생략) <br />
	 * String[2]는 순환소수 시작부분 index를 나타낸다. <br />
	 ...
	 * String[3]은 순환소수 끝부분 index를 나타낸다. <br />
	 * 1/6=0.1666...의 경우 6 이 반복되고 6은 1666... 에서 1번째 인덱스이므로 값은 1이 된다.<br />
