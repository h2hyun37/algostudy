 ...
 *
 */
public class Problem22 extends AbstractProblem<Long> {

	private static final String[] NAMES = { "MARY", "PATRICIA", "LINDA",
	...
	public void problem() {
		...
		for (int i = 0; i < NAMES.length; i++) {
			...
			for (char ch : NAMES[i].toCharArray()) {
				wordPoint += ALPHABET.valueOf(String.valueOf(ch)).toPoint();
			}
			
			result += wordPoint * (i + 1);
		}
	}
	...
	private int partition(String[] array, int startIndex, int endIndex) {
		String criteriaValue = array[endIndex];
		int pivotIndex = startIndex;
		
		for (int i = startIndex; i < endIndex; i++) {
			if (array[i].compareTo(criteriaValue) <= 0) {
