...
public class Graph<T> {
	 ...
	 * 
	 * @param root - the vertex to set as the root and optionally add if it does not exist in the graph.
	 */
	 ...
	 * 
	 * @param v - the search starting point
	 * @param visitor - the vistor whose vist method is called prior to visting a
	 *            vertex.
